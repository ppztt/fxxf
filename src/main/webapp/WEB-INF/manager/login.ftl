            ...
            <div class="class-5">
                ...
                <div class="class-6">
                    ...
                    <el-form :model="form" ref="form" :rules="rules">
                     ...
                     <span class="input input--hoshi" :class="{'input--filled': isName }">
                          <input ref="management" v-model="form.managerName" class="input__field input__field--hoshi"
    ...
    var app = new Vue({
        ...
        watch: {
            'form.managerName': function (n, o) {
                ...
                this.$set(this.form, 'managerName', n)
            }
        },
        methods: {
            //登录
