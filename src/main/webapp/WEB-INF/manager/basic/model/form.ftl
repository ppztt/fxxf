<el-dialog id="form" :title="(addEditForm.modelIsMenu == 1) ? '菜单编辑' : '按钮编辑'" :visible.sync="dialogVisible" :close-on-click-modal="false" width="50%" v-cloak @close="close">
    <template slot="title">
...
<script>
    var form = new Vue({
        ...
        methods: {
            close(){
                this.$refs.treeselect.clearSelected()
            },
            open: function (id) {
