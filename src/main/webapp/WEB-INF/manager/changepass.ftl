        ...
        <div  class="class-2">
            ...
            <div  class="class-5">
                ...
                <div  class="class-6" >
                    ...
                    <div class="class-7">
                        密码修改
                        <div style="font-size: 16px;color: #F56C6C;display: inline;">超过{{passChangeMaxDay}}天未修改密码</div>
                    </div>
                    <!--文本结束-->
                    <!--小容器开始-->
                    <el-form :model="resetPasswordForm" ref="resetPasswordForm" :rules="resetPasswordFormRule">
                     ...
                     <span class="input input--hoshi">
                          <input v-model="resetPasswordForm.managerName" class="input__field input__field--hoshi" type="text" id="input-name" readonly disabled/>
                  ...
                  <span class="input input--hoshi">
                          <input v-model="resetPasswordForm.oldManagerPassword" class="input__field input__field--hoshi" type="password" id="oldManagerPassword"/>
                          <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="oldManagerPassword">
                  ...
                  <span class="input input--hoshi">
                          <input v-model="resetPasswordForm.newManagerPassword" class="input__field input__field--hoshi" type="password" id="newManagerPassword" />
                          <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="newManagerPassword">
                  ...
                  <span class="input input--hoshi">
                          <input v-model="resetPasswordForm.newComfirmManagerPassword" class="input__field input__field--hoshi" type="password" id="newComfirmManagerPassword" />
                          <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="newComfirmManagerPassword">
