 ...
 */
@Data
public class ApplicantsStoreExcelImportVo implements Serializable, IExcelModel, IExcelDataModel {
   ...
   // @NotBlank(message = "经营场所-所在镇不能为空")
    ...
    @NotBlank(message = "适用商品-承诺事项及内容不能为空")
    ...
    @NotBlank(message = "退货约定-承诺事项及内容不能为空")
