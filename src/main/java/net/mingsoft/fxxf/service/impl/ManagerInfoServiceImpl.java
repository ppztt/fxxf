...
import net.mingsoft.fxxf.mapper.ManagerInfoMapper;
...
public class ManagerInfoServiceImpl extends ServiceImpl<ManagerInfoMapper, ManagerInfo> implements ManagerInfoService {
    ...
    public List<ManagerInfoVo> userList(Integer current, Integer size, String keyword) {
        ...
        List<ManagerInfoVo> userList = managerInfoMapper.userList(keyword, page);
    ...
    public void deleteUser(String id) {
        ...
        managerInfoService.removeManagerInfoById(id);
    }
    ...
    public ManagerInfoVo getManagerInfoById(String userId) {
        ...
        ManagerEntity managerEntity = managerService.getById(userId);
        ManagerInfo managerInfo = getById(userId);
    ...
    public void insertManagerInfo(ManagerInfoVo user) {
        ...
        boolean save = managerService.save(managerEntity);
        if (save) {
    ...
    public void updateManagerInfoById(ManagerInfoVo user) {
        ...
        managerEntity.setUpdateBy(loginUser.getId());
        managerInfo.setUpdateTime(new Date());
        managerService.saveOrUpdate(managerEntity);
        saveOrUpdate(managerInfo);
    }
    ...
    private ManagerEntity checkManagerId(String managerId) {
        ManagerEntity dbUser = managerService.getById(managerId);
        if (dbUser == null) {
