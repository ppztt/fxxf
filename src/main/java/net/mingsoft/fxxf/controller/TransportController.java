...
public class TransportController {
	...
	public ApiResult unit(@RequestBody List<TransportUnitNewApplyVo> transportUnitNewApplyVos){
		...
		try {
			...
			List<Applicants> applicants = myApplicantsUnitService.findApplicantsByCreditCodes(1, creditCodes);
			...
			myApplicantsUnitService.saveBatch(applicantsList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ApiResult store(@RequestBody List<TransportStoreNewApplyVo> transportStoreNewApplyVos){
		...
		try {
			...
			List<Applicants> applicants = myApplicantsUnitService.findApplicantsByCreditCodes(2, creditCodes);
